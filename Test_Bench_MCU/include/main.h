...
#define moteur_3_PUL_Pin GPIO_PIN_15
#define moteur_3_PUL_GPIO_Port GPIOB
#define moteur_2_PUL_Pin GPIO_PIN_6
#define moteur_2_PUL_GPIO_Port GPIOC
#define moteur_1_PUL_Pin GPIO_PIN_7
