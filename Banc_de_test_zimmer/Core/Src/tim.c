...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM23_MspInit 0 */
    ...
    PF1     ------> TIM23_CH2
    */
    GPIO_InitStruct.Pin = encoder_4_A_Pin|encoder_4_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    PC8     ------> TIM8_CH3
    */
    GPIO_InitStruct.Pin = encoder_vertical_left_A_Pin|encoder_vertical_left_B_Pin|encoder_vertical_left_Z_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD15     ------> TIM4_CH4
    */
    GPIO_InitStruct.Pin = moteur_1_PUL_Pin|moteur_2_PUL_Pin|moteur_3_PUL_Pin|moteur_4_PUL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, encoder_vertical_right_A_Pin|encoder_vertical_right_B_Pin);
  ...
  /* USER CODE END TIM23_MspDeInit 0 */
    ...
    PF1     ------> TIM23_CH2
    */
    HAL_GPIO_DeInit(GPIOF, encoder_4_A_Pin|encoder_4_B_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC8     ------> TIM8_CH3
    */
    HAL_GPIO_DeInit(GPIOC, encoder_vertical_left_A_Pin|encoder_vertical_left_B_Pin|encoder_vertical_left_Z_Pin);
